...
class SimpleModulePlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        switch (module.type) {
            case ModuleDefinition.Type.main:
                ...
                modules.findAll {
                    it.scope == ModuleDefinition.Scope.local || it.scope == ModuleDefinition.Scope.shared
                }.each { dependency ->
                ...
                return
            case ModuleDefinition.Type.biz:
                //自动加入自己的API模块依赖
                ...
                break
            case ModuleDefinition.Type.api:
                break
            case ModuleDefinition.Type.thirds:
                break
            default:
