...
@Lazy
public class SelfOperationParameterReader implements OperationBuilderPlugin {
    ...
    @Autowired
    public SelfOperationParameterReader(
    ...
    private boolean shouldExpand(final ResolvedMethodParameter parameter, ResolvedType resolvedParamType) {
        return !parameter.hasParameterAnnotation(RequestBody.class)
                ...
                && !parameter.hasParameterAnnotation(JsonContent.class)
